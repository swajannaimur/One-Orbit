...
export default function Navbar() {
    ...
    const navItems = [
        ...
        { href: "/create-post", label: "Create Project", icon: HiOutlineSparkles },
                        ...
                        >
                            ...
                            <div className="flex flex-col">
                                <span className="text-lg lg:text-xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 dark:from-white dark:to-gray-200 bg-clip-text text-transparent">
                                    One<span className="bg-gradient-to-br from-blue-500 to-purple-600 bg-clip-text text-transparent">Orbit</span>
                                </span>
                                <span className="text-xs text-gray-500 dark:text-gray-400 font-medium hidden sm:block">management platform</span>
                            </div>
                        </Link>
