            ...
            <div className="grid lg:grid-cols-2 h-full">
              ...
              <div className="flex flex-col justify-center p-8 lg:p-12 space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <button className="px-8 py-4 bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-2xl hover:shadow-2xl transition-all duration-300 hover:scale-105 transform focus:outline-none focus:ring-4 focus:ring-blue-500/20">
                    {slide.cta.primary}
                  </button>
              ...
              <div className="relative hidden lg:flex items-center justify-center p-8">
                <div className="relative w-full h-96">
                  {/* Mockup Device */}
                  <div className="absolute inset-0 bg-linear-to-br from-white to-gray-100 dark:from-gray-800 dark:to-gray-700 rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-600 transform rotate-3">
                      ...
                      {[70, 85, 60].map((percent, idx) => (
                        <div key={idx} className="space-y-2">
                          ...
                          <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2">
                            <div 
                              className={`h-2 rounded-full bg-linear-to-r ${slide.color}`}
                              style={{ width: `${percent}%` }}
                            ></div>
                          </div>
                        </div>
