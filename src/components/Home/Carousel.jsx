...
const Carousel = () => {
  ...
  return (
    <section className="relative w-full max-w-8xl mx-auto bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900/20  shadow-2xl overflow-hidden">
