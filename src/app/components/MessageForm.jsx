  ...
  async function handleSubmit(e) {
    ...
    try {
      const res = await fetch('/api/developers/message', {
        ...
        body: JSON.stringify({ developerId, developerEmail, name, email, message }),
      })
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div>
        ...
        <textarea className="textarea textarea-bordered w-full" rows={6} value={message} onChange={(e) => setMessage(e.target.value)} />
      </div>
