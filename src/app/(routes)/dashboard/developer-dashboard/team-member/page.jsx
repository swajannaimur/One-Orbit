      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-green-500">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm">Total Invites</p>
                <p className="text-3xl font-bold text-gray-800">{invites.length}</p>
              </div>
                          ...
                          <tr key={inv._id} className="hover:bg-gray-50 transition-colors">
                            ...
                            <td className="p-4">
                              <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg hover:from-blue-600 hover:to-purple-600 transition-all shadow-md text-sm"
                              >
                                <FaUserEdit />
                                Update Status
                              </button>
        ...
        <div className="mt-8 flex flex-wrap gap-4 justify-center">
          ...
          <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg shadow-md hover:from-blue-600 hover:to-purple-600 transition-all">
            <FaUsers />
            Export Team Data
          </button>
          <button className="flex items-center gap-2 px-6 py-3 bg-white text-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all border border-gray-200">
