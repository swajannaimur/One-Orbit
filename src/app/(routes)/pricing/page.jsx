              ...
              >
                {plan.popular && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 z-10">
                    <div className="bg-linear-to-r from-amber-400 to-orange-500 text-white px-6 py-2 rounded-full text-sm font-semibold shadow-lg flex items-center gap-2">
                ...
                <div className={`relative bg-white dark:bg-gray-800 rounded-3xl shadow-lg border transition-all duration-500 flex flex-col ${plan.popular
                  ...
                  <div className="p-8 flex-1">
                    <div className="flex items-center gap-3 mb-4">
                      <div className={`w-12 h-12 bg-linear-to-r ${plan.color} rounded-xl flex items-center justify-center`}>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4">
              Compare all <span className='linear-text'>Features</span>
            </h2>
            ...
            {comparisonFeatures.map((section, idx) => (
              <div key={idx} className="border-b border-gray-200 dark:border-gray-700 last:border-b-0">
                <div className="bg-gray-50 dark:bg-gray-700/50 px-6 py-4">
                  <h3 className="text-lg font-semibold linear-text dark:text-white">
                    {section.category}
                  </h3>
                </div>
