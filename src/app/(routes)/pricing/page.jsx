        ...
        <div className="text-center mb-16">
          ...
          <div className="flex items-center justify-center gap-4 mb-12">
            ...
            <button
              ...
              className="relative w-14 h-7 bg-gray-300 dark:bg-gray-600 rounded-full transition-colors duration-300 focus:outline-none focus:ring-4 focus:ring-blue-500/20"
            >
          ...
          {plans.map((plan, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`relative bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl border transition-all duration-500 h-full flex flex-col ${
                  isPopular 
                  ...
                  <div className="p-8 flex-1">
                    ...
                    {/* CTA Button */}
                    <button className={`w-full py-4 font-semibold rounded-2xl transition-all duration-300 mb-8 ${
                      isPopular
              ...
              <div key={sectionIndex} className="border-b border-gray-200 dark:border-gray-700 last:border-b-0">
                ...
                <div className="divide-y divide-gray-200 dark:divide-gray-700">
                  {section.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="grid grid-cols-4 gap-4 px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors duration-200">
