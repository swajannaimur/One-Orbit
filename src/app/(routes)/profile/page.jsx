    ...
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-gray-100 p-6 mt-20 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 flex flex-col items-center text-center border border-gray-100 dark:border-gray-700">
          ...
          <h3 className="mt-5 text-2xl font-semibold text-gray-800 dark:text-gray-100">
            {user.name}
          </h3>
          ...
          {user.skills?.length > 0 && (
            <div className="mt-5 flex flex-wrap justify-center gap-2">
              {user.skills.map((skill, i) => (
                <span
                  key={i}
                  className="bg-indigo-50 text-indigo-600 text-xs font-medium px-3 py-1 rounded-full dark:bg-indigo-900/30 dark:text-indigo-300"
                >
                  {skill}
                </span>
              ))}
          ...
          {/* Small Divider */}
          <div className="w-full border-t mt-6 mb-4 border-gray-100 dark:border-gray-700"></div>
          ...
          <div className="mt-4 flex flex-col gap-2">
            {user.portfolio && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2 bg-indigo-50 text-indigo-700 rounded-lg text-sm font-medium hover:bg-indigo-100 transition text-center dark:bg-indigo-900/30 dark:text-indigo-300 dark:hover:bg-indigo-800/50"
              >
                View Portfolio
              </a>
            )}
            {user.resume && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-4 py-2 bg-green-50 text-green-700 rounded-lg text-sm font-medium hover:bg-green-100 transition text-center dark:bg-green-900/30 dark:text-green-300 dark:hover:bg-green-800/50"
              >
                Download Resume
              </a>
            )}
        ...
        <div className="md:col-span-2 flex flex-col gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
            <h4 className="text-lg font-semibold flex items-center gap-2 text-gray-800 mb-3 dark:text-gray-200">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
              <div className="p-5 bg-gray-50 dark:bg-gray-900/30 rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-900/50 transition">
              ...
              <div className="p-5 bg-gray-50 dark:bg-gray-900/30 rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-900/50 transition">
                ...
                <p className="text-xl font-semibold text-gray-800 dark:text-gray-100">34</p>
                <p className="text-sm text-gray-500 dark:text-gray-400">Tasks Completed</p>
              </div>
              <div className="p-5 bg-gray-50 dark:bg-gray-900/30 rounded-xl hover:bg-indigo-50 dark:hover:bg-indigo-900/50 transition">
                <HiOutlineEnvelope className="w-6 h-6 text-green-600 mx-auto mb-2" />
                <p className="text-xl font-semibold text-gray-800 dark:text-gray-100">5</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-gray-100 dark:border-gray-700">
            ...
            <ul className="space-y-4 text-gray-700 dark:text-gray-300 text-sm md:text-base">
              <li className="border-l-4 border-indigo-500 pl-4 hover:bg-indigo-50 dark:hover:bg-indigo-900/50 rounded transition">
                Updated project status to{" "}
                <span className="font-semibold">“In Progress”</span>.
              </li>
              <li className="border-l-4 border-green-500 pl-4 hover:bg-green-50 dark:hover:bg-green-900/50 rounded transition">
                Completed{" "}
                <span className="font-semibold">UI Enhancement Task</span>.
              </li>
              <li className="border-l-4 border-yellow-500 pl-4 hover:bg-yellow-50 dark:hover:bg-yellow-900/50 rounded transition">
                Commented on{" "}
