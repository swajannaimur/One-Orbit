...
const Page = async () => {
  ...
  return (
    <div className="min-h-screen mt-20 bg-linear-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-950 py-8 transition-colors duration-300">
      <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
                <FiLayout className="text-blue-600 dark:text-blue-400 text-lg" />
              </div>
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Step 1</p>
                <p className="font-semibold text-gray-900 dark:text-white">Project Details</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-green-100 dark:bg-green-900/30 rounded-lg">
                <FiPlusCircle className="text-green-600 dark:text-green-400 text-lg" />
              </div>
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Step 2</p>
                <p className="font-semibold text-gray-900 dark:text-white">Add Content</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
                <FiCheckCircle className="text-purple-600 dark:text-purple-400 text-lg" />
              </div>
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">Step 3</p>
                <p className="font-semibold text-gray-900 dark:text-white">Review & Submit</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500 dark:text-gray-400">
            ...
            <a
              href="/guide"
              className="text-primary hover:text-primary/80 dark:text-blue-400 dark:hover:text-blue-300 font-medium transition-colors"
            >
